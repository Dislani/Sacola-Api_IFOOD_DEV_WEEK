    ...
    public Item incluirItemNaSacola(ItemDto itemDto) {
        ...
        if (itensDaSacola.isEmpty()) {
            ...
            if (restauranteAtual.equals(restauranteDoItemParaAdicionar)) {
                ...
                throw new RuntimeException("Não é possivel adicionar produtos de restaurantes diferentes. Conclua seu pedido no restaurante atual ou ou esvazie a sacola para comprar em outro restaurante");
            }
        }
